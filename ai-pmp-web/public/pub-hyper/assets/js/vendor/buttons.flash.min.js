      ...
      if (g.isPlainObject(c)) N(c);
        ...
        if (G) {
          ...
          for (f = d.attributes.length - 1; 0 <= f; f--) {
            ...
            -1 !== n.indexOf(":") &&
              (e.push({ name: n, value: l }), d.removeAttribute(n));
          }
          f = 0;
  ...
  w.ext.buttons.excelFlash = g.extend({}, I, {
    ...
    action: function (a, b, c, d) {
          ...
          for (var k = 0, F = h.length; k < F; k++) {
            ...
            y ||
              ...
              (h[k].match &&
                ...
                : ((D = h[k].replace
                    ? h[k].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "")
                    : h[k]),
                  (y = t(e, "c", {
      ...
      var v = function (h, k) {
          ...
          F[0].appendChild(
            t(e, "mergeCell", { attr: { ref: "A" + h + ":" + M(k) + h } })
          );
      ...
      d.footer &&
        l.footer &&
        (p(l.footer, f), g("row:last c", e).attr("s", "2"));
      u.messageBottom && (p([u.messageBottom], f), v(f, l.header.length - 1));
      p = t(e, "cols");
      g("worksheet", e).prepend(p);
      v = 0;
      for (x = l.header.length; v < x; v++)
        p.appendChild(
          t(e, "col", {
            attr: { min: v + 1, max: v + 1, width: S(l, v), customWidth: 1 },
          })
        );
